...
| --- | --- | --- | --- | --- |
| CockroachDB is the persistent memory layer | `sql/schema.sql`, `api/src/repository.ts` | 10 API tests + `artifacts/evidence/local-demo.json` | pending live cluster | pending Devpost receipt |
